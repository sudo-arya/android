...
fun UnitConverter() {
    ...
    val customTextStyle = androidx.compose.ui.text.TextStyle(
        ...
        fontSize = 32.sp,
//        color = Color(120, 0, 120)
        color = MaterialTheme.colorScheme.primary
    )

    fun convertUnits() {
        val inputValueDouble = inputValue.toDoubleOrNull() ?: 0.0
        val result = (inputValueDouble * iConversionFactor.value * 100.0 / oConversionFactor.value)
            .roundToInt() / 100.0
    ...
    Column(
        ...
        OutlinedTextField(
            value = inputValue,
            onValueChange = {
                //here goes what should happen when the value in text field changes
                inputValue = it
                convertUnits()
            },
...
//            Button(onClick = { Toast.makeText(context,"Thanks for Clicking !!",Toast.LENGTH_LONG)
//                .show() }) {
//                Text(text = "MyButton")
...
//                Input Button
                Button(onClick = {
                    ...
                    Text(text = inputUnit)
                    Icon(Icons.Default.ArrowDropDown, contentDescription = "Dropdown for selection")
                }
